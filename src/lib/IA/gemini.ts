...
export async function mejorarComentarioIALargo(texto: string): Promise<string> {
    const prompt = `
    Corrige el siguiente resumen general de la auditoría para que suene claro, profesional y directo. 
    Mantén la redacción mediana, con lenguaje técnico apropiado para un informe de auditoría. 
    No uses explicaciones, ni devoluciones en formato Markdown. Solo responde con el texto corregido.
