      ...
      <div className="flex flex-col items-center justify-between flex-grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link href="/" className="lg:hidden">
            ...
            <div className="dark:hidden flex items-center gap-1">
              <div className="w-6 h-6 bg-brand-500 rounded-md"></div>
              <p className="text-xl font-bold">Audapp</p>
            </div>
            {/* Logo personalizado */}
            ...
            <div className="hidden dark:flex  items-center gap-1">
              <div className="w-6 h-6 bg-brand-500 rounded-md"></div>
              <p className="text-xl font-bold text-white">Audapp</p>
            </div>
          ...
          <div className='hidden md:flex gap-1 items-center'>
            <div className="h-6 w-6 bg-indigo-500 rounded-lg"></div>
            <p className="text-xl font-semibold">Audapp</p>
          </div>
        </div>
        <div
